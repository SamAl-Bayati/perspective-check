...
amplify_primary_branch_name = "prod"
# In CI, this is injected automatically from dev state.
# For manual local apply, set this explicitly, for example:
# amplify_additional_branch_api_base_urls = { dev = "https://<dev-api-id>.execute-api.us-east-1.amazonaws.com" }
amplify_additional_branch_api_base_urls = {}
amplify_production_branch_names         = ["prod"]
frontend_api_base_url                   = ""

lambda_function_name                  = "perspective-check-api-prod"
